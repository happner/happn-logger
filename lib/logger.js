var LoggerInstance = require('./logger_instance');
...
module.exports.configure = function(config) {
  ...
  if (typeof config.logCacheSize == 'number')    Config.logCacheSize         = config.logCacheSize;
  if (config.logLevel)                           Config.logLevel             = config.logLevel;
  ...
  if (config.logComponents)                      Config.logComponents        = config.logComponents;
...
module.exports.createContext = function(context) {
  return {
    createLogger: function(component) {
      return new LoggerInstance(Config, context, component);
    }
  }
}

module.exports.createLogger = function(component) {
  return new LoggerInstance(Config, undefined, component);
}
